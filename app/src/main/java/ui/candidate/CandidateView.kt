...
class CandidateView @JvmOverloads constructor(
    ...
    init {
        ...
        // 建立水平佈局
        candidateLayout = LinearLayout(context).apply {
    ...
    private fun createCandidateView(candidate: Char, index: Int): TextView {
    ...
    interface CandidateClickListener {
        fun onCandidateClick(candidate: Char, index: Int)
    }
}
