...
class QwertyKeyboardView @JvmOverloads constructor(
    ...
    private fun addFunctionKeyRow() {
        ...
        val heightDp = 56
        val heightPx = (heightDp * resources.displayMetrics.density).toInt()
        spaceButton.layoutParams = LinearLayout.LayoutParams(
            0,
            heightPx,
            3f
        )
    ...
    private fun createFunctionKeyButton(label: String, key: String): android.widget.Button {
        val button = KeyButton(context)
        button.text = label
    ...
    interface KeyClickListener {
         ...
         * 按鍵長按
         */
        fun onKeyLongPress(key: String, alternatives: List<String>)
    }
}
